...
from players.default_player  import Player as p3 #problematic code
...
class  clockGame():
    ...
    def __init__(self, args):
        ...
        self.choose_pens = args.myparams
        self.players = args.myplayers
    ...
    def initialise_player(self, player_px, player_number):
        if player_number == 0:
            if player_px == 0:
                ...
                self.player_instances[0] = p5(self.rng, self.choose_pens)
            elif player_px == 6:
...
if __name__ == '__main__':
    ...
    parser.add_argument("--myparams", metavar='N', type=float, nargs='+', help="choose penalties")
    parser.add_argument("--myplayers", metavar='N', type=int, nargs='+', help="players 1,2,3")
